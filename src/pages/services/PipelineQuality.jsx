                ...
                <div className="container max-w-4xl">
                    ...
                    <div className="bg-white p-8 border-l-4 border-[var(--color-primary)] shadow-sm">
                        <p className="text-xl text-gray-900 leading-relaxed">
                            Pipelines that look strong in volume<br />
                ...
                <div className="container max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            "How deals progress through buyer decisions",
                            "Where deals should exit the funnel"
                        ].map((card, i) => (
            ...
            <section className="section">
                <div className="container max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[
                            "Buyer-centric stage exit criteria",
                            "Qualification logic aligned to ICP",
            ...
            <section className="section bg-gray-900 text-white">
                <div className="container max-w-4xl">
                    ...
                    <div className="flex flex-wrap gap-4">
                        {["Lead generation", "Sales training", "CRM re-implementation"].map(item => (
