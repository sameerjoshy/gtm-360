...
const ForecastingGovernance = () => {
    return (
        <div className="service-detail-page">
            <Helmet>
                <title>Forecasting & Revenue Governance | GTM-360</title>
                <meta name="description" content="Fix unreliable forecasts by establishing clear logic, signal governance, and leadership review rhythms." />
                <link rel="canonical" href="https://gtm-360.com/services/forecasting-governance" />
            </Helmet>
                ...
                <div className="container max-w-4xl">
                    ...
                    <div className="bg-white p-8 border-l-4 border-[var(--color-primary)] shadow-sm">
                        <p className="text-xl text-gray-900 leading-relaxed">
                            Forecasts that exist<br />
                            but aren’t trusted or decision-useful.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="section">
                <div className="container max-w-4xl">
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            "Forecast swings week to week",
                            "Over-reliance on rep judgment",
            ...
            <section className="section bg-[var(--color-secondary)]">
                <div className="container max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            "Forecast becomes a decision tool",
                            "Clear linkage between signals and confidence",
                            "Reduced opinion-driven debates"
                        ].map((card, i) => (
            ...
            <section className="section">
                <div className="container max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[
                            "Forecasting logic tied to deal signals",
                            "Governance rhythm",
                            "Exception-based inspection model",
                            "Leadership review artifacts"
                        ].map(item => (
            ...
            <section className="section bg-gray-900 text-white">
                <div className="container max-w-4xl">
                    ...
                    <div className="flex flex-wrap gap-4">
                        {["FP&A support", "Tool configuration", "Spreadsheet redesign"].map(item => (
